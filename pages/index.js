...
export default function Home() {
  ...
  const currentLanguage = 'en'; // Root page is always English
  ...
  return (
    <div suppressHydrationWarning={true} lang="en">
      <Head>
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                     ...
                     onClick={(e) => {
                       ...
                       if (isOpen) {
                         ...
                         e.currentTarget.querySelector('.faq-icon').style.transform = 'rotate(180deg)';
                                      ...
                                      <h3 className="text-lg font-semibold text-slate-800">What is van Gogh ai Paint by Text?</h3>
                ...
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>van Gogh ai Paint by Text is an advanced AI-powered image editing tool that allows you to modify images using simple text descriptions. Built on InstructPix2Pix technology, it understands natural language commands and applies them to create stunning visual transformations.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">How does the AI understand my text instructions?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>Our AI uses advanced machine learning models trained on millions of image-text pairs. It can interpret natural language descriptions like "make the sky purple," "add a sunset," or "convert to Van Gogh style" and apply these changes to your uploaded images with remarkable accuracy.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">Is van Gogh ai really free to use?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>Yes, van Gogh ai is completely free to use with no hidden costs, subscription fees, or usage limits. We believe in democratizing AI art creation and making these powerful tools accessible to everyone worldwide.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">What types of images work best?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>van Gogh ai works well with most image types, including photos, illustrations, and digital art. High-resolution images typically yield better results. The AI is particularly effective with clear subjects and well-defined objects in your images.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">How long does it take to process an image?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>Most image transformations are completed within 10-30 seconds, depending on the complexity of the request and current server load. Simple style changes are typically faster, while complex scene modifications may take a bit longer.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                ...
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>You can use images generated with van Gogh ai for personal and commercial purposes. However, please ensure you have the rights to the original images you upload. We recommend reviewing our terms of service for detailed information about usage rights.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">Are my images stored on your servers?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>No, we prioritize your privacy. Your uploaded images and generated results are processed temporarily and not permanently stored on our servers. We're committed to maintaining your creative privacy and data security.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="faq-item border border-slate-200 rounded-lg overflow-hidden">
                <div className="faq-question cursor-pointer p-6 bg-slate-50 hover:bg-slate-100 transition-colors duration-200 flex justify-between items-center"
                  ...
                  <h3 className="text-lg font-semibold text-slate-800">Need More Help?</h3>
                  <span className="faq-icon text-slate-600 text-xl transition-transform duration-200">⌄</span>
                </div>
                <div className="faq-answer max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                  <div className="p-6 text-slate-700">
                    <p>For other questions, contact: hangchen.zhu@hiwinda.com</p>
                  </div>
                </div>
              </div>
            </div>
